...
<head>
   ...
   <!-- custom css file link  -->
    <link rel="stylesheet" href="/css/discussionCSS.css">
</head>
<body>
...
<div class="side-bar">
 ...
 <h1 id="discuss-state">Start A Discussion</h1>
...
<section id="video-section">
   ...
   <video autoplay muted loop>
     <source src="/images/discuss2.mp4" type="video/mp4">
   ...
   <!--
      ...
      <div id="discuss-container">
         <form id="post-form">
           <input id="post-content" placeholder="Write your discussion here..."></input> 
          <button type="submit">Reply</button>
         </form>
     
   </div> 

   <button id="dbutton">View Past Discussions</button>
  ...
  <!--
<section>
   <h1>Previous Discussions</h1>
 </section>
 
 <div id="past-question">
   <h2 id="post-name"><i class="fa-solid fa-user"></i>  David B</h2>
   <h2 id="post-position">Lecturer</h2>
   <p id="questions">What are the contributions AI has made to web technologies?</p>
   <p>5 replies</p>
 </div>
